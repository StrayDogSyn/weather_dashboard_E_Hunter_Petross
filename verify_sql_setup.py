    ...
    try:
        with sqlite3.connect(db_path) as conn:
            ...
            if weather_count > 0:
                ...
                cursor.execute("SELECT city_name, temperature, condition, timestamp FROM weather_history LIMIT 3")
...
def verify_configuration():
    ...
    if env_file.exists():
        ...
        if "OPENWEATHER_API_KEY=" in content and len(content.split("OPENWEATHER_API_KEY=")[1].split('\n')[0].strip()) > 10:
