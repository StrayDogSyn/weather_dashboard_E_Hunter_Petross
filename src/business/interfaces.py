...
class IWeatherService(ABC):
    ...
    @abstractmethod
    async def get_weather_forecast(self, city: str, days: int = 7, country: str = None) -> List[Dict[str, Any]]:
...
class ICityComparisonService(ABC):
    ...
    @abstractmethod
    async def compare_cities(self, cities: List[str], metrics: List[str] = None) -> Dict[str, Any]:
    ...
    @abstractmethod
    async def get_comparison_history(self, cities: List[str], start_date: date, end_date: date) -> Dict[str, Any]:
...
class IWeatherJournalService(ABC):
    ...
    @abstractmethod
    async def create_entry(self, city: str, content: str, weather_data: Dict[str, Any] = None) -> str:
    ...
    @abstractmethod
    async def get_entries_by_city(self, city: str, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    @abstractmethod
    async def get_entries_by_date_range(self, start_date: date, end_date: date) -> List[Dict[str, Any]]:
...
class IActivitySuggestionService(ABC):
    ...
    @abstractmethod
    async def get_suggestions(self, weather_data: Dict[str, Any], preferences: Dict[str, Any] = None) -> List[Dict[str, Any]]:
    ...
    @abstractmethod
    async def get_suggestions_by_category(self, category: str, weather_data: Dict[str, Any]) -> List[Dict[str, Any]]:
...
class IWeatherPoetryService(ABC):
    ...
    @abstractmethod
    async def generate_poem(self, weather_data: Dict[str, Any], style: str = "haiku") -> str:
    ...
    @abstractmethod
    async def save_poem(self, poem: str, weather_data: Dict[str, Any], style: str) -> str:
...
class IStorageService(ABC):
    ...
    @abstractmethod
    async def query(self, collection: str, filters: Dict[str, Any] = None, limit: int = None) -> List[Dict[str, Any]]:
