...
class WeatherService:
    ...
    def get_weather_for_favorites(self, units: str = "metric") -> Dict[str, Optional[WeatherData]]:
        """
            ...
            for city_data in data['cities']:
                try:
                    ...
                    favorite = FavoriteCity(
                        ...
                        last_viewed=datetime.fromisoformat(city_data['last_viewed']) if city_data.get('last_viewed') else None
                    )
        ...
        try:
            ...
            for fav in self.favorite_cities:
                city_data = {
                    ...
                    'last_viewed': fav.last_viewed.isoformat() if fav.last_viewed else None
                }
    ...
    def _save_weather_history(self, weather_data: WeatherData) -> None:
        ...
        try:
            ...
            entry = {
                ...
                'timestamp': weather_data.timestamp.isoformat() if weather_data.timestamp else datetime.now().isoformat()
            }
