...
class WeatherDashboardAppFactory:
    ...
    def _setup_logging(self) -> None:
        ...
        try:
            ...
            root_logger.setLevel(getattr(logging, log_config.get('level', DEFAULT_LOG_LEVEL)))
            ...
            file_handler.setLevel(getattr(logging, log_config.get('level', DEFAULT_LOG_LEVEL)))
    ...
    def _initialize_container(self) -> None:
        ...
        try:
            ...
            self._container.initialize(self._config_manager)
