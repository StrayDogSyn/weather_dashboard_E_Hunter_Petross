...
class VoiceConfig:
    ...
    personality_traits: List[str] = field(default_factory=lambda: ["helpful", "curious", "witty"])
    ...
    def load_config(self) -> AppConfig:
        ...
        try:
            ...
            if os.path.exists(self._config_file):
                ...
                self._logger.warning(f"Configuration file not found: {self._config_file}")
    ...
    def _load_from_file(self) -> None:
        ...
        try:
            ...
            if config_path.suffix.lower() == '.json':
                ...
                self._logger.warning(f"Unsupported config file format: {config_path.suffix}")
    ...
    def _load_from_environment(self) -> None:
        ...
        for env_var, config_path in self._env_mappings.items():
            ...
            if env_value is not None:
                ...
                self._logger.debug(f"Set {config_path} from environment variable {env_var}")
    ...
    def _validate_config(self) -> None:
        ...
        if self._config.voice.enabled:
            ...
            if self._config.voice.voice_profile not in valid_profiles:
                errors.append(f"Invalid voice profile: {self._config.voice.voice_profile}")
            
            valid_environments = ['dev', 'staging', 'prod']
            if self._config.voice.deploy_environment not in valid_environments:
                errors.append(f"Invalid deploy environment: {self._config.voice.deploy_environment}")
