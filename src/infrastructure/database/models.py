...
class JournalEntryModel:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'JournalEntryModel':
        ...
        return cls(
            ...
            mood=data.get('mood'),
            activities=json.loads(data.get('activities', '[]')) if data.get('activities') else [],
            tags=json.loads(data.get('tags', '[]')) if data.get('tags') else [],
            is_favorite=bool(data.get('is_favorite', False)),
            is_private=bool(data.get('is_private', False)),
            template_id=data.get('template_id'),
            attachments=json.loads(data.get('attachments', '[]')) if data.get('attachments') else [],
            created_at=datetime.fromisoformat(data['created_at']) if data.get('created_at') else None,
            updated_at=datetime.fromisoformat(data['updated_at']) if data.get('updated_at') else None,
...
class SettingsModel:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'validation_rules': json.dumps(self.validation_rules) if self.validation_rules else None,
            'created_at': self.created_at.isoformat() if self.created_at else None,
            'updated_at': self.updated_at.isoformat() if self.updated_at else None
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'SettingsModel':
        ...
        if raw_value is None:
            ...
            value = raw_value.lower() in ('true', '1', 'yes', 'on') if isinstance(raw_value, str) else bool(raw_value)
        elif data_type == 'json':
        ...
        if raw_default is None:
            ...
            default_value = raw_default.lower() in ('true', '1', 'yes', 'on') if isinstance(raw_default, str) else bool(raw_default)
        elif data_type == 'json':
        ...
        return cls(
            ...
            validation_rules=json.loads(data['validation_rules']) if data.get('validation_rules') else None,
            created_at=datetime.fromisoformat(data['created_at']) if data.get('created_at') else None,
            updated_at=datetime.fromisoformat(data['updated_at']) if data.get('updated_at') else None
        )
...
class WeatherCacheModel:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'data_type': self.data_type,
            'weather_data': json.dumps(self.weather_data) if self.weather_data else '{}',
            'provider': self.provider,
            'quality_score': self.quality_score,
            'request_params': json.dumps(self.request_params) if self.request_params else None,
            'response_metadata': json.dumps(self.response_metadata) if self.response_metadata else None,
            'created_at': self.created_at.isoformat() if self.created_at else None,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'WeatherCacheModel':
        ...
        return cls(
            ...
            weather_data=json.loads(data.get('weather_data', '{}')) if data.get('weather_data') else {},
            provider=data.get('provider', 'openweather'),
            quality_score=data.get('quality_score', 1.0),
            request_params=json.loads(data['request_params']) if data.get('request_params') else None,
            response_metadata=json.loads(data['response_metadata']) if data.get('response_metadata') else None,
            created_at=datetime.fromisoformat(data['created_at']) if data.get('created_at') else None,
