...
class WeatherPoetryService:
    ...
    def generate_haiku(self, weather: CurrentWeather) -> WeatherPoem:
        ...
        templates = self.haiku_templates.get(condition, self.haiku_templates[WeatherCondition.CLEAR])
    ...
    def generate_fun_phrase(self, weather: CurrentWeather) -> WeatherPoem:
        ...
        phrases = self.weather_phrases.get(condition, self.weather_phrases[WeatherCondition.CLEAR])
    ...
    def _create_temperature_haiku(self, temp_descriptor: str, condition: WeatherCondition) -> List[str]:
    ...
    def generate_weather_poetry(self, weather: CurrentWeather, poetry_type: str = "random") -> WeatherPoem:
        """
    ...
    def create_poetry_collection(
        ...
        self.logger.info(f"Generated {len(poems)} poems for {weather.location.display_name}")
        return poems
