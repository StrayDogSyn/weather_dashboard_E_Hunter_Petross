...
from .weather_components import WeatherCard
from .layout import ResponsiveLayout, ModernLayoutMixin

# Note: WeatherDashboard import will be added after class definition to avoid circular import


class WeatherDashboardGUI(IUserInterface, ModernLayoutMixin):
