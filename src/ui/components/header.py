...
class ApplicationHeader(GlassmorphicFrame):
    ...
    def __init__(self, parent, on_settings: Optional[Callable] = None,
                 on_refresh: Optional[Callable] = None,
                 on_help: Optional[Callable] = None, **kwargs):
    ...
    def _setup_ui(self) -> None:
        ...
        header_container.grid(row=0, column=0, columnspan=3, sticky="ew", padx=15, pady=10)
    ...
    def _create_weather_status_bar(self) -> None:
        ...
        status_frame.grid(row=1, column=0, columnspan=3, sticky="ew", padx=15, pady=(0, 5))
        ...
        self.weather_icon_label.grid(row=0, column=0, padx=(10, 5), pady=5)
        ...
        self.temp_display_label.grid(row=0, column=1, sticky="w", padx=5, pady=5)
        ...
        status_text.grid(row=0, column=2, sticky="e", padx=(5, 10), pady=5)
    ...
    def set_connection_status(self, connected: bool) -> None:
        ...
        """
        if connected:
            status_color = self.style.colors['success']
            status_icon = "🟢"
            status_text = "Connected"
        else:
            status_color = self.style.colors['error']
            status_icon = "🔴"
