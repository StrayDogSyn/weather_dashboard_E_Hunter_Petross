...
class WeatherCard(GlassmorphicFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        self.last_updated_label.grid(row=2, column=0, columnspan=2, sticky="ew", pady=(10, 0))
    ...
    def _create_details_section(self, parent) -> None:
        ...
        self.details_frame.grid(row=1, column=0, columnspan=2, sticky="ew", pady=(20, 0))
    ...
    def _create_detail_row(self, parent, row: int, icon: str, label: str, 
                          value: str, key: str) -> None:
