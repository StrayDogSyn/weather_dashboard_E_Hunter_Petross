...
def is_severe_weather_condition(condition: str, wind_speed: float = 0, precipitation: float = 0) -> bool:
    """
    ...
    return (
        condition.lower() in severe_conditions or
        wind_speed > 50 or  # Strong wind (km/h)
        precipitation > 10  # Heavy precipitation (mm)
    )
