...
from src.models.predictive_models import WeatherPredictor, ModelType, PredictionResult, ModelMetrics
from src.services.model_training_service import ModelTrainingService, TrainingResult
from src.services.model_integration_service import ModelIntegrationService, IntegratedForecast
...
class TestWeatherPredictor(unittest.TestCase):
    ...
    def test_model_training_success(self):
        ...
        try:
            metrics = self.predictor.train_models(features_df, target_column='temp_celsius')
...
class TestModelTrainingService(unittest.TestCase):
    ...
    def test_save_and_load_training_history(self):
        ...
        sample_result = TrainingResult(
            ...
            model_metrics={'test_model': ModelMetrics(mae=1.0, mse=2.0, rmse=1.4, r2=0.8, cv_score=0.75)},
...
class TestModelIntegrationService(unittest.TestCase):
    ...
    def test_model_weights_calculation(self):
        ...
        sample_metrics = {
            'linear_regression': ModelMetrics(mae=1.0, mse=2.0, rmse=1.4, r2=0.9, cv_score=0.85),
            'random_forest': ModelMetrics(mae=0.8, mse=1.5, rmse=1.2, r2=0.95, cv_score=0.90)
        }
